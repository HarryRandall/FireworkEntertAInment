...
---
> Every piece of feedback we have received from our stakeholder, Robert Foti (ICON Pyrotechnics International), with the response we took and the evidence that closed the loop. Complements the full minutes on each stakeholder meeting page.
> **How we use this log**
  - Every meeting we capture feedback inline in the minutes, then distil it into this page so it is traceable at a glance.
  - Each row links to the source meeting and, where relevant, the Linear issue or GitHub PR where the action landed.
  - Refreshed at the end of each sprint.
...
[Open Stakeholder Meeting 1](https://www.notion.so/325cd8a5bf0880639dbde55fec373283)
...
[Open Stakeholder Meeting 2](https://www.notion.so/32ccd8a5bf08807a93d5c6ed3a582589)
...
[Open Stakeholder Meeting 3](https://www.notion.so/333cd8a5bf0880ef9d92c9f02f38ce87)
...
> For completeness, this log also captures the feedback received from our tutor at the end of Sprint 1. These items drove the changes in Sprint 2 planning.
