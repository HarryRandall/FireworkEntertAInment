...
author: From Notion
last_edited_time: '2026-05-11 03:33:00.000'
...
- Solomon's full feedback (verbatim)

	> Hi Firework EntertAInment team,

	> Good work in sprint 2. Please find your feedback for this sprint attached below.

	> **Stakeholder Engagement**

	> The team has had consistent and proactive engagement with the stakeholder throughout the sprint, with consistent weekly meetings and email correspondence. Notably, the team has demonstrated the ability to navigate uncertainty and adapt to changes to project requirements introduced by the stakeholder. In instances where the stakeholder has explicitly stated specific expectations, the team has managed to integrate these smoothly into existing plans and workflows. The team's meeting documentation are detailed and well-structured, with a clear system that links stakeholder feedback to team responses and action items.

	> **Planning and Organisation**

	> The team has a clear and well-thought-out plan for the project. They have noticeably improved since sprint 1, with their planning documents now containing clearly articulated sprint goals, deliverables and milestones. Tasks are mapped to sprint goals and have accompanying time estimates. The team has also explicitly accounted for project risks such as public holidays, technical constraints and music copyright and have developed strategies for mitigating these risks. Lastly, the team has demonstrated good strategic planning and foresight with early plans for sprint 3 underway.

	> **Execution and Quality**

	> The team has executed tasks with high quality, on time and with clear justifications this sprint. They have made substantial progress and managed to deliver a functional product with early implementations of several core features. Users can log in and authenticate, create new fireworks shows, and receive AI-driven recommendations. Development has also begun on more advanced functionality, namely 3D rendering of fireworks using WebGL, generation of shopping lists that include stores where the items can be purchased, and background music for fireworks shows. Overall, this sprint has positioned the team well to deliver a polished, high-quality product to the stakeholder.

	> **Reflection and Improvement**

	> The team has demonstrated critical reflection, responding effectively to feedback from both the stakeholder and tutor. Client feedback has been used to actively refine MVP features and requirements. The team also maintains detailed notes on what is going well, current issues, and proposed resolutions. They have also been able to make improvements to their organisation and workflow based on sprint 1 tutor feedback, showing the ability to critically analyse and act on feedback.

	> If you have any questions or would like to discuss any of the feedback in more detail, please don't hesitate to reach out.

	> Thanks, Solomon.

 | Rubric area | Tutor verdict | What we carry into Sprint 3 | 
 | ---- | ---- | ---- | 
 | Stakeholder Engagement (20%) | Strong - consistent weekly meetings and email cadence; smooth integration of stakeholder expectations; meeting docs link feedback to team responses and action items. | Keep the same meeting / feedback-log cadence with Robert in Sprint 3 (see ([https://www.notion.so/356cd8a5bf088133a867dfe56851b2ab](https://www.notion.so/356cd8a5bf088133a867dfe56851b2ab])); aim for a mid-sprint check-in and a Sprint 3 demo. | 
 | Planning and Organisation (20%) | Strong - clearly articulated sprint goals, deliverables and milestones; tasks mapped to sprint goals with estimates; risks explicitly accounted for; Sprint 3 planning already underway. | Sprint 3 page mirrors this shape: explicit MVP-for-Robert goal, owner-grouped deliverables, Linear issues mapped to streams, risks (cue drift, catalogue pollution, parity divergence, integration tax). | 
 | Execution and Quality (40%) | Strong - functional product delivered with auth, show creation, AI-driven recommendations, plus WebGL rendering, shopping lists with vendor info, and background music for shows. | Sprint 3 focuses Execution on stitching the loop end-to-end (song -> AI -> cues -> renderer -> Finale 3D CSV) rather than starting new product surfaces. | 
 | Reflection and Improvement (20%) | Strong - critical reflection on both stakeholder and tutor feedback; detailed notes on issues / resolutions; Sprint 1 tutor feedback visibly actioned in Sprint 2. | Continue the per-teammate reflection format in each Day Overview; capture Solomon's Sprint 2 feedback (this section) as the input for Sprint 3 retrospective. | 
