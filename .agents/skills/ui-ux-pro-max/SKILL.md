...
Read the repository's `AGENTS.md`, existing tokens, local primitives, and route
implementation before applying a recommendation. Project-specific product,
security, accessibility, data, and workflow invariants override this generic
reference. Do not replace an established design system or add a dependency only
because it appears in the search results.
