...
import { Button, Card, StatTile } from '@/components/design-system';
...
function simulateResult(assortment: AdminAssortmentSummary): SimulatedResult {
  const cueCount = Math.max(6, assortment.itemCount * 4);
  return {
    cueCount,
