...
import type { UserActivityDatum } from '@/app/(admin)/admin/users/[id]/_components/UserActivityChart';

export function UserActivityChartPlot({ data }: { data: UserActivityDatum[] }) {
