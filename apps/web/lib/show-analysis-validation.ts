...
// bounded bar-grid confidence. Preserve the actual version in stored data.
export type SupportedAnalyserResult = z.infer<typeof analyserResultSchema>;
/** Compatibility alias for existing analyser runner callers. */
export type AnalyserV14Result = SupportedAnalyserResult;
