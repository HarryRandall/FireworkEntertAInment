 ...
 * TypeScript catalogue in `apps/web/lib/fireworks/effect-catalogue.ts`.
 *
 ...
 *
 *   pnpm --filter @showcrafter/web exec node scripts/generate-firework-catalogue-migration.mjs
 */
...
const cataloguePath = join(appRoot, 'lib', 'fireworks', 'effect-catalogue.ts');
...
const tmpPath = join(repoRoot, '.tmp-catalogue.mjs');
...
lines.push(`-- Generated from lib/fireworks/effect-catalogue.ts by`);
lines.push(`-- supabase/catalogue/generate-firework-catalogue-migration.mjs. Re-run the`);
