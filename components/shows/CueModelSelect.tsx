        ...
        {sortedModelOptions.map((option) => {
          ...
          return (
            <DropdownMenuItem
              ...
              className={cn(
                'focus:bg-muted focus:text-foreground flex h-8 cursor-pointer items-center gap-2 rounded-md px-2 text-[13px] transition-colors outline-none',
                isSelected && 'bg-muted',
              )}
            >
              ...
              <span
                className={cn(
                  'shrink-0 rounded-md px-1.5 py-0.5 text-[10px] leading-none font-medium tabular-nums',
