-- Follow-up safety migration for environments that already applied an earlier
-- draft which renamed public.firework_effects.family to public.firework_effects.type.
