-- Seed the Lallassu-derived firework designs into effect_specs.
--
...
insert into public.effect_specs (
  ...
  ('lallassu-fib-gold', 'Gold Sphere', 'Round gold burst with strobing flair and crackle.',
  ...
  ('lallassu-fib-red', 'Red Sphere', 'Round red burst, classic chrysanthemum feel.',
    'shell', 6.0, 1, 220, 'manual', 1,
  ...
  ('lallassu-fib-blue', 'Blue Sphere', 'Cool blue radial burst with light flair.',
  ...
  ('lallassu-fib-green', 'Green Sphere', 'Vivid green chrysanthemum with light glitter trails.',
  ...
  ('lallassu-fib-mega', 'Mega Gold Bloom', 'Huge gold bloom with heavy boom and rich crackle.',
  ...
  ('lallassu-wave-rainbow', 'Rainbow Wave', 'Sine-wave burst with mixed flair colours.',
  ...
  ('lallassu-wave-purple', 'Purple Wave', 'Slow swirling purple stars with crackle ends.',
  ...
  ('lallassu-wave-cyan', 'Cyan Wave', 'Bright cyan stars with sweeping wave trajectories.',
  ...
  ('lallassu-strobe-white', 'White Strobe', 'Heavy strobing white shell with deep boom.',
  ...
  ('lallassu-strobe-red', 'Red Strobe', 'Aggressive red strobe with pulsing brightness.',
  ...
  ('lallassu-strobe-mixed', 'Mixed Strobe', 'Random-colour strobing storm with crackle.',
  ...
  ('lallassu-fib-mini', 'Mini Sphere', 'Small fast bloom for quick volleys.',
