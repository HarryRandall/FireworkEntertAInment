...
const PROMPT_TEXTAREA_CLASS = 'font-mono text-xs leading-relaxed';
...
function PromptContentSkeleton({ activeKey }: { activeKey: PromptTabKey }) {
  ...
  return (
    <>
      ...
      <Card radius="md" className="p-4 pb-5 shadow-xs" aria-label="Loading prompt editor">
  ...
  return (
    <Card radius="md" className="p-4 pb-5 shadow-xs">
      <form action={updatePromptConfigAction} className="flex flex-col gap-4">
        ...
        <Field className="flex min-w-0 flex-col space-y-0">
...
function PromptCardHeader({
  ...
  return (
    <div className="flex items-start justify-between gap-4">
      <div className="flex min-w-0 items-start gap-3">
        <span className="border-border bg-muted text-foreground inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md border">
          {icon}
        </span>
        <div className="min-w-0">
