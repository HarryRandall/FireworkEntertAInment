...
const SYSTEMS: System[] = [
  { name: "Web app", description: "showcrafter.app and the dashboard", status: "operational", uptime: "99.99%" },
  { name: "Audio analyser", description: "Beat & tempo detection (librosa pipeline)", status: "operational", uptime: "99.97%" },
  { name: "Choreography agent", description: "LLM cue planner & SKU mapper", status: "operational", uptime: "99.92%" },
  { name: "Live preview (WebGL)", description: "Real-time 3D show rendering", status: "operational", uptime: "99.95%" },
  { name: "Vendor catalogue sync", description: "ICON Pyrotechnics inventory feed", status: "operational", uptime: "99.98%" },
  { name: "Authentication", description: "Login, signup, password reset", status: "operational", uptime: "100.00%" },
  { name: "Storage (audio uploads)", description: "Supabase Storage", status: "operational", uptime: "99.99%" },
];
        ...
        <Container>
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <div className="flex-grow">
                ...
                <p className="text-sm text-on-surface-variant">
                  Last checked {new Date().toLocaleTimeString("en-AU", { hour: "2-digit", minute: "2-digit" })} AEST
                </p>
              </div>
            </Card>
            ...
            <div className="mt-12">
              ...
              <div className="mt-4 divide-y divide-outline-variant/15 overflow-hidden rounded-2xl border border-outline-variant/15 bg-surface-container-low">
                {SYSTEMS.map((system) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <span className={`inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest ${tone.text}`}>
            ...
            <div className="mt-16">
              ...
              <h2 className="mt-3 text-2xl font-bold tracking-tight text-on-surface md:text-3xl">
                Recent history.
              </h2>
              <div className="mt-8 space-y-4">
                {INCIDENTS.map((incident) => (
                  <Card key={incident.title} radius="md" className="p-6">
                    ...
                    <h3 className="mt-1.5 text-base font-bold text-on-surface">
                      {incident.title}
                    </h3>
