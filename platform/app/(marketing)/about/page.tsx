...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="border-b border-outline-variant/15 py-12">
        <Container>
        ...
        <Container>
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-2 gap-6 md:grid-cols-4">
            {TEAM.map((member) => (
              ...
              >
                <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-primary/30 to-primary-container/40 text-2xl font-extrabold text-primary">
                  {member.name
                    .split(" ")
                    .map((n) => n[0])
                    .join("")}
