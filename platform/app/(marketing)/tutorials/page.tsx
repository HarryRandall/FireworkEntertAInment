...
const TUTORIALS: Tutorial[] = [
  ...
  },
  {
    ...
    excerpt:
      'What makes a track easy or hard for the choreographer to work with — and how to set yourself up to win.',
  },
  {
    level: 'Beginner',
    duration: '5 min read',
  ...
  },
  {
    ...
    excerpt:
      'Stack singles before the drop, save the cake for the third bar, and time the finale to the riser.',
  },
  {
    level: 'Intermediate',
    duration: '9 min read',
    ...
    excerpt:
      'How to maximise spectacle when you can only spend two hundred dollars at your local stockist.',
  },
  {
    level: 'Advanced',
    ...
    excerpt:
      'Build a show with verse, chorus, bridge and finale segments that share a colour palette.',
  },
  {
    level: 'Advanced',
    ...
    excerpt:
      'When to override the agent — moving cues, swapping SKUs, and locking spacing across complex bars.',
  },
];
        ...
        <Container>
          ...
          <div className="mx-auto mt-20 max-w-2xl text-center">
            ...
            <p className="text-on-surface-variant mt-3 text-base leading-relaxed">
              Subscribe to the monthly digest for one in-depth breakdown of a real ShowCrafter show,
              including the song, the budget and the cue grid.
            </p>
          </div>
        </Container>
      </section>
