...
export const SHOW_STYLES: Record<ShowStyleKey, ShowStyleDefinition> = {
  signature: {
    ...
    promptDirectives: [
      ...
      '  - Choruses and drops saturate: fire every slot, layer multi-shot cakes under single-shot pops.',
      '  - Buildups must audibly ramp - increase density beat over beat into the drop.',
      '  - The final section is the biggest moment of the show. Hold back at least two of the largest-calibre products for it.',
  ...
  cinematic: {
    ...
    promptDirectives: [
      ...
      '  - Open sparse and elegant: single shells with long trails, about 40-50% fill in the intro.',
      '  - Each section should feel larger than the last - track a rising arc across the whole song.',
      '  - Use willows, horsetails, and falling-leaves effects for emotional moments; save strobes for peaks.',
      '  - The finale is gold-dominant: willows, glitter, and crackle layered across all tubes.',
