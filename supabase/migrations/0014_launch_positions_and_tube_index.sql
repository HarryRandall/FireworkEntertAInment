-- Renderer rewrite: per-show mortar positions and per-cue tube index.
--
...
--    only has the new firework designs to choose from. New seeds live in
--    supabase/seed-firework-designs.sql.
...
-- Drop legacy/manual presets so the renderer only sees the new firework
