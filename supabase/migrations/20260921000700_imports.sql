-- ShowCrafter baseline: imports.
set check_function_bodies = false;

CREATE OR REPLACE FUNCTION "private"."firework_import_sha256"("p_value" "text") RETURNS "text"
...
ALTER FUNCTION "private"."firework_import_sha256"("p_value" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "private"."mark_firework_import_worker_claimed"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "private"."mark_firework_import_worker_claimed"() OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "private"."resolve_firework_import_credit"("p_run_id" "uuid", "p_outcome" "text", "p_reason" "text") RETURNS "void"
...
ALTER FUNCTION "private"."resolve_firework_import_credit"("p_run_id" "uuid", "p_outcome" "text", "p_reason" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."append_firework_import_run_output"("p_run_id" "uuid", "p_lease_token" "uuid", "p_stage" "text", "p_sequence" integer, "p_output_type" "text", "p_schema_version" "text", "p_payload" "jsonb", "p_content_hash" "text" DEFAULT NULL::"text", "p_storage_path" "text" DEFAULT NULL::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."append_firework_import_run_output"("p_run_id" "uuid", "p_lease_token" "uuid", "p_stage" "text", "p_sequence" integer, "p_output_type" "text", "p_schema_version" "text", "p_payload" "jsonb", "p_content_hash" "text", "p_storage_path" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."approve_firework_import_candidate"("p_job_id" "uuid", "p_candidate_id" "uuid", "p_part_number" "text", "p_name" "text", "p_manufacturer" "text" DEFAULT NULL::"text", "p_category" "text" DEFAULT NULL::"text", "p_firework_type" "text" DEFAULT NULL::"text") RETURNS TABLE("catalogue_item_id" "uuid", "firework_ids" "uuid"[], "multishot_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."approve_firework_import_candidate"("p_job_id" "uuid", "p_candidate_id" "uuid", "p_part_number" "text", "p_name" "text", "p_manufacturer" "text", "p_category" "text", "p_firework_type" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."archive_firework_import_job"("p_job_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."archive_firework_import_job"("p_job_id" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."begin_firework_import_dispatch"("p_run_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."begin_firework_import_dispatch"("p_run_id" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."check_firework_import_dispatch_ready"() RETURNS boolean
...
ALTER FUNCTION "public"."check_firework_import_dispatch_ready"() OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."claim_firework_import_run"("p_processor_version" "text", "p_requested_run_id" "uuid" DEFAULT NULL::"uuid", "p_lease_seconds" integer DEFAULT 900) RETURNS TABLE("run_id" "uuid", "job_id" "uuid", "lease_token" "uuid", "storage_path" "text", "source_name" "text", "selected_model" "text", "request_kind" "text", "request_prompt" "text", "parent_candidate" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."claim_firework_import_run"("p_processor_version" "text", "p_requested_run_id" "uuid", "p_lease_seconds" integer) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."complete_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_candidates" "jsonb", "p_selected_ordinal" integer) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."complete_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_candidates" "jsonb", "p_selected_ordinal" integer) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."current_firework_import_render_validator_version"() RETURNS "text"
...
ALTER FUNCTION "public"."current_firework_import_render_validator_version"() OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."current_firework_import_renderer_contract_version"() RETURNS "text"
    LANGUAGE "sql" IMMUTABLE PARALLEL SAFE
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."current_firework_import_renderer_contract_version"() OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."current_firework_import_validator_version"() RETURNS "text"
    LANGUAGE "sql" IMMUTABLE PARALLEL SAFE
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."current_firework_import_validator_version"() OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."fail_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_error_message" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."fail_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_error_message" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."finalise_firework_video_import"("p_source_name" "text", "p_storage_path" "text", "p_original_name" "text", "p_selected_model" "text", "p_reported_duration_seconds" numeric DEFAULT NULL::numeric) RETURNS TABLE("job_id" "uuid", "run_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."finalise_firework_video_import"("p_source_name" "text", "p_storage_path" "text", "p_original_name" "text", "p_selected_model" "text", "p_reported_duration_seconds" numeric) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."heartbeat_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_stage" "text", "p_progress" integer, "p_lease_seconds" integer DEFAULT 900) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."heartbeat_firework_import_run"("p_run_id" "uuid", "p_lease_token" "uuid", "p_stage" "text", "p_progress" integer, "p_lease_seconds" integer) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."lock_firework_import_lease"("p_run_id" "uuid", "p_lease_token" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."lock_firework_import_lease"("p_run_id" "uuid", "p_lease_token" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."record_firework_import_dispatch_result"("p_run_id" "uuid", "p_outcome" "text", "p_attempt_count" integer, "p_call_id" "text" DEFAULT NULL::"text", "p_error" "text" DEFAULT NULL::"text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."record_firework_import_dispatch_result"("p_run_id" "uuid", "p_outcome" "text", "p_attempt_count" integer, "p_call_id" "text", "p_error" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."record_firework_import_media_probe"("p_run_id" "uuid", "p_lease_token" "uuid", "p_duration_seconds" numeric, "p_width" integer, "p_height" integer, "p_source_probe" "jsonb", "p_normalized_preview" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."record_firework_import_media_probe"("p_run_id" "uuid", "p_lease_token" "uuid", "p_duration_seconds" numeric, "p_width" integer, "p_height" integer, "p_source_probe" "jsonb", "p_normalized_preview" "jsonb") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."record_firework_import_run_context"("p_run_id" "uuid", "p_lease_token" "uuid", "p_source_sha256" "text", "p_pipeline_version" "text", "p_engine_schema_version" "text", "p_video_model" "text", "p_prompt_snapshot" "jsonb", "p_model_snapshot" "jsonb", "p_modal_call_id" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."record_firework_import_run_context"("p_run_id" "uuid", "p_lease_token" "uuid", "p_source_sha256" "text", "p_pipeline_version" "text", "p_engine_schema_version" "text", "p_video_model" "text", "p_prompt_snapshot" "jsonb", "p_model_snapshot" "jsonb", "p_modal_call_id" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."seal_firework_import_candidate"("p_candidate_id" "uuid", "p_validator_version" "text", "p_canonical_reconstruction" "jsonb", "p_content_hash" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."seal_firework_import_candidate"("p_candidate_id" "uuid", "p_validator_version" "text", "p_canonical_reconstruction" "jsonb", "p_content_hash" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."seal_firework_import_render_validation"("p_candidate_id" "uuid", "p_validator_version" "text", "p_canonical_evidence" "jsonb", "p_artifact_storage_path" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $_$
declare
...
ALTER FUNCTION "public"."seal_firework_import_render_validation"("p_candidate_id" "uuid", "p_validator_version" "text", "p_canonical_evidence" "jsonb", "p_artifact_storage_path" "text") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."select_firework_import_candidate"("p_job_id" "uuid", "p_candidate_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."select_firework_import_candidate"("p_job_id" "uuid", "p_candidate_id" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."start_firework_import_run"("p_job_id" "uuid", "p_request_kind" "text", "p_selected_model" "text", "p_idempotency_key" "text", "p_request_prompt" "text" DEFAULT NULL::"text") RETURNS "public"."import_runs"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."start_firework_import_run"("p_job_id" "uuid", "p_request_kind" "text", "p_selected_model" "text", "p_idempotency_key" "text", "p_request_prompt" "text") OWNER TO "postgres";
